...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}exports.__esModule=!0,exports.ConversationsApi=void 0;var _keys=require("babel-runtime/core-js/object/keys"),_keys2=_interopRequireDefault(_keys),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_possibleConstructorReturn2=require("babel-runtime/helpers/possibleConstructorReturn"),_possibleConstructorReturn3=_interopRequireDefault(_possibleConstructorReturn2),_inherits2=require("babel-runtime/helpers/inherits"),_inherits3=_interopRequireDefault(_inherits2),_base=require("./base"),_http=require("../utils/http"),ConversationsApi=exports.ConversationsApi=function(e){function t(){return(0,_classCallCheck3["default"])(this,t),(0,_possibleConstructorReturn3["default"])(this,e.apply(this,arguments))}return(0,_inherits3["default"])(t,e),t.prototype.get=function(e){var t=this.getFullURL("appUsers",e,"conversation");return this.validateAuthHeaders().then(function(e){return(0,_http.http)("GET",t,{},e)})},t.prototype.sendMessage=function(e,t){var r=this.getFullURL("appUsers",e,"conversation","messages");return this.validateAuthHeaders().then(function(e){return(0,_http.http)("POST",r,t,e)})},t.prototype.uploadImage=function(e,t){var r=arguments.length<=2||void 0===arguments[2]?{}:arguments[2],s=this.getFullURL("appUsers",e,"conversation","images");return this.validateAuthHeaders().then(function(e){var n=new FormData;return n.append("source",t),(0,_keys2["default"])(r).forEach(function(e){n.append(e,r[e])}),(0,_http.http)("POST",s,n,e)})},t.prototype.resetUnreadCount=function(e){var t=this.getFullURL("appUsers",e,"conversation","read");return this.validateAuthHeaders().then(function(e){return(0,_http.http)("POST",t,{},e)})},t}(_base.BaseApi);

},{"../utils/http":8,"./base":3,"babel-runtime/core-js/object/keys":12,"babel-runtime/helpers/classCallCheck":16,"babel-runtime/helpers/inherits":17,"babel-runtime/helpers/possibleConstructorReturn":18}],5:[function(require,module,exports){
...
},{"babel-runtime/core-js/object/create":11,"babel-runtime/core-js/object/set-prototype-of":13,"babel-runtime/helpers/typeof":19}],18:[function(require,module,exports){
...
},{"babel-runtime/core-js/symbol":15,"babel-runtime/helpers/typeof":19}],20:[function(require,module,exports){
